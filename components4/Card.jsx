                 ...
                 <div className={style.card2}>
                  ...
                  <div className={style.info}>
                    <div className={style.iconContainer}>
                      <img src="/bed.png" alt="Rooms" className={style.rpic} />
                      <span className={style.rno}>
                        2
                      </span>
                    </div>
                    <div className={` ${style.iconContainer2} `}>
                      <img
                        src="/bathtub.png"
                        alt="Rooms"
                        className={style.bpic}
                      />
                      <span className={style.rno}>
                        3
                      </span>
                    </div>
                    <div className={style.pkPrice}>
                      4000
                      <span className={style.unit}>Rs</span>
                    </div>
                  </div>
                </div>
                <a href={`/detail/`} className={style.priceContainer}>
                  <motion.button
                    whileTap={{
                      scale: 0.8,
                    }}
