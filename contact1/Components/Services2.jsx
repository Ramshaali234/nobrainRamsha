...
<motion.div className={stylees3.aboutSections} onViewportEnter={() => {
    ...
    <img
           ...
           <p className={stylees3.aboutParagraph}>
           An "all-cash offer" refers to a situation in which a buyer intends to purchase a property or an asset using only cash, without involving any financing from a mortgage or loan.
           </p>
    </motion.div>
</motion.div>
